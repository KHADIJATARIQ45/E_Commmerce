...
<li><a href='my_account.php?account'>MY ACCOUNT</a></li>
  ...
  echo "<h2 id='box'>PLEASE login Or signUp your account!</h2>";
}
else
{
  echo "
...
<li><a href='contact.php'>CONTACT US</a></li>
<li class='dropdown'>
<a href='#' class='dropdown-toggle' id='chngclr' data-toggle='dropdown' onclick='clr()' style='text-decoration:none; color:white; font-size:18px;'>
MANAGE ACCOUNT<span class='caret'></span></a>
...
";
   echo "<h2 style='color:#862d86; font-weight:bold; font-style:vendara; margin-left:50px;'>MANAGE YOUR ACCOUNT</h2><hr>"; 
    getdefault(); 
}
?>
<?php
...
function clr()
{
   document.getElementById("chngclr").style.color = "#990099";
}
</script>
<!--footer start-->
