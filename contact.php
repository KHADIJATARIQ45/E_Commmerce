...
<h1 class="text-center chead">Contact Us</h1></br>
<div class="container-fluid">
<div id="map" style="width:100%;height:400px;"></div>
</div>
<script type="text/javascript">
  function initMap() {
        var uluru = {lat:24.929468 , lng: 67.042116};
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA245IzpxiE8lbVy1X5Wknil2-LNRJu1dU&callback=initMap"></script>

<div class="container">
 <div class="row" style="margin-top:2%; margin-bottom:4%;">
 <div class="col-md-4 text-left " style="font-size:28px; margin-top:6%;">
...
<div class="col-md-8" style="margin-top:5%;">
      ...
      <div class="row">
        <div class="col-md-12 form-group">
          <button class="btn btn-pur pull-right" type="submit">Send</button>
        </div>
      </div>
    </div>
