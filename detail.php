...
<div id="detail">
            ...
            while($row_product=mysqli_fetch_array($run_product))
           {
            ...
            <div class='row'>
            <div class='col-md-6'>
            <img src='admin_area/product_image/$pro_image1' id='myImg' class='img-responsive' height='100' width='230'>
            </div> 
            <div class='col-md-6 det' style='margin-top:7%;'>
            <div id='single_product' style='text-align:left;'>
            <h1 style='font-weight:bold; font-size:30px; color:#862d86; font-family:sans-serif;'>$pro_title</h1>
            <hr>
            <h4 style='font-weight:bold;'>Key Features</h4>
            <p style='padding-bottom:2%;'>$pro_desc</p><br><hr>
            <p style='font-size:25px;'><b>Price: $pro_price</b></p>
            <a href='index.php?add_cart=$pro_id'><button class='btn btn-pur pull-right'>Add to Cart</button></a>
            </div>
            </div>
            </div>
            ";
