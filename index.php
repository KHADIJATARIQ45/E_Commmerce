...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item text-center active">
      <img src="img/c1.jpg" alt="Chania" class="img-responsive" width="1600" height="400">
    </div>

    <div class="item text-center">
      <img src="img/c2.jpg" alt="Chicago" class="img-responsive" width="1600" height="400">
    </div>

    <div class="item text-center">
      <img src="img/c3.jpg" alt="New York" class="img-responsive" width="1600" height="400" >
    </div>

    <div class="item text-center" id="slider4">
      <img src="img/c4.jpg" alt="New York" class="img-responsive" width="1600" height="400">
    </div>
  </div>
...
<!--content start-->
<div class="row text-center" style="padding-top:1.2%;">
<div class="col-md-2">
...
<h2 id="content" class="pro">Featured Products</h2>
<?php 
getpro();
getbrandpro();
getcatpro();
