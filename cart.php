...
<div class="container" style="margin-bottom:5%;">
  <h1 class="text-left" style="font-weight:bold;">CART</h1>
  <br>
<form action="cart.php" method="post" enctype="multipart/form-data">
<div class="table-responsive">
<table class="table" style="overflow-x:auto;" style="text-align:center;">
...
<label><a href="cart.php?remove=<?php echo $pro_id; ?>" style="font-weight:2px; text-align:left;">Remove</a>
</div>
</td>
<td><img src="admin_area/product_image/<?php echo $product_image; ?>" height="80" width="80"> </td>
<td><select name="qty">
<option>1</option>
<option>2</option>
<option>3</option>
...
<tr >
<td align="right" colspan="4"><h4 style="margin-top:50px; font-size:30px; font-weight:bold; color:#862d86;">Sub Total:<h4></td>
<td align="right"><h4 style="margin-top:50px; font-size:30px; font-weight:bold;"><?php echo $total; ?></h4></td>
</tr> 

<tr>
<td>
<input type="submit"  class="btn btn-p pull-left" name="update" value="Update Cart" style=" margin:10px;">
</td>
</tr>
<!--for continue-->
<?php
...
<button class="btn btn-p pull-right" ><a href="checkout.php"  style="text-decoration:none; color:white; margin:10px;">CheckOut</a></button> 
</div>
